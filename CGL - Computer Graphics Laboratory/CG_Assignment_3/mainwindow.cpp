...
void MainWindow::DDALine(float x1, float y1, float x2, float y2,int flag)
{
...
void MainWindow::mousePressEvent(QMouseEvent *event)
{
    ...
    if(start)
    {
        ...
        {
            DDALine(VerticesX[numVertices - 1],VerticesY[numVertices - 1],VerticesX[numVertices],VerticesY[numVertices],0);
        }
...
void MainWindow::boundary(int flag)
{
    ...
    //    ui->label_2->setPixmap(QPixmap::fromImae(img));
